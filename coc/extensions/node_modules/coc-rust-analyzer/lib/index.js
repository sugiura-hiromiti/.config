...
var cancelFlycheck = new lc.RequestType0("rust-analyzer/cancelFlycheck");
...
function cancelFlycheck2(ctx) {
  return async () => {
    await ctx.client.sendRequest(cancelFlycheck);
  };
}
...
async function activate(context) {
  ...
  ctx.registerCommand("reload", (ctx2) => {
    return async () => {
      import_coc6.window.showInformationMessage(`Reloading rust-analyzer...`);
      ...
      import_coc6.window.showInformationMessage(`Reloaded rust-analyzer`);
    };
  });
