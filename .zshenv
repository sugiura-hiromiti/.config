...
alias n='nvim'
alias u='yabai --stop-service ; yabai --uninstall-service ; brew upgrade ; brew upgrade neovim --fetch-HEAD ; rustup self update ; rustup update ; cargo install-update -a'
alias zo='z $OLDPWD'
